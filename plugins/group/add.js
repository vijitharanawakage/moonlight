...
let handler = async (m, { conn, text, participants }) => {
	...
	let img = await conn.profilePictureUrl(m.chat, 'image').catch(_ => 'https://raw.githubusercontent.com/shizothetechie/moonlight-database/refs/heads/main/images/moonlight.jpg')
	for (let i of users) {
