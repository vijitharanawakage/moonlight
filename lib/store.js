...
/** @type {typeof import('@shizodevs/baileys')} */ // @ts-ignore
const {
	initAuthCreds,
	BufferJSON,
	proto,
...
function makeInMemoryStore() {
	/** @type {{ [jid: string]: { id: string, lastfetch?: number, subject?: string, name?: string, isChats?: boolean, isContact?: boolean, presence?: import('@shizodevs/baileys').PresenceData, metadata?: import('@shizodevs/baileys').GroupMetadata } & import('@shizodevs/baileys').Chat & import('@shizodevs/baileys').Contact }}} */
	let chats = {}
	/** @type {{ [jid: string]: import('@shizodevs/baileys').proto.WebMessageInfo[] }} */
	let messages = {}
	/** @type {import('@shizodevs/baileys').ConnectionState} */
	...
	function loadMessage(jid, id = null) {
		...
		if (jid && !id) {
			id = jid
			/** @type {(m: import('@shizodevs/baileys').proto.WebMessageInfo) => Boolean} */
	...
	/**
	 * @param {string} jid 
	 * @param {(jid: string) => Promise<import('@shizodevs/baileys').GroupMetadata> | null} groupMetadata 
	 */
	...
	/**
	 * @param {string} jid 
	 * @param {import('@shizodevs/baileys').proto.WebMessageInfo} message 
	 */
	...
	/** 
	 * @param {import('@shizodevs/baileys').BaileysEventEmitter} ev 
	 * @param {{ groupMetadata: (jid: string, minimal?: boolean) => Promise<import('@shizodevs/baileys').GroupMetadata> | null }} opts
	 */
