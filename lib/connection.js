...
/** @type {import('baileys-elite').UserFacingSocketConfig} */
 ...
 *  credsUpdate?: () => void 
 * }} EventHandlers
 * @typedef {Required<import('baileys-elite').UserFacingSocketConfig>['logger']} Logger
 ...
 * @this {Socket}
 * @param {StartOptions} opts
 * @param {import('baileys-elite').BaileysEventMap<unknown>['connection.update']} update
 */
