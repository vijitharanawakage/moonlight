...
export function HelperConnection(conn, { store, logger }) {
	...
	/** @type {import('baileys-elite').WASocket} */
	let sock = Object.defineProperties(conn, {
		...
		sendContact: {
			 ...
			 * @param {import('baileys-elite').proto.WebMessageInfo} quoted 
			 * @param {Object} options 
			 */
...
`.trim()
		...
		loadMessage: {
			 ...
			 * @returns {import('baileys-elite').proto.WebMessageInfo}
			 */
			value(jid, id) {
		...
		serializeM: {
			 ...
			 * @param {import('baileys-elite').proto.WebMessageInfo} m
			 */
			value(m) {
				return smsg(conn, m)
			},
