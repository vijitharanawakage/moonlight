...
export function HelperConnection(conn, { store, logger }) {
	...
	/** @type {import('@shizodevs/baileys').WASocket} */
	let sock = Object.defineProperties(conn, {
		...
		sendContact: {
			 ...
			 * @param {import('@shizodevs/baileys').proto.WebMessageInfo} quoted 
			 * @param {Object} options 
			 */
...
`.trim()
		...
		loadMessage: {
			 ...
			 * @returns {import('@shizodevs/baileys').proto.WebMessageInfo}
			 */
			value(jid, id) {
		...
		serializeM: {
			 ...
			 * @param {import('@shizodevs/baileys').proto.WebMessageInfo} m
			 */
			value(m) {
				return smsg(conn, m)
			},
...
export function serialize() {
	return Object.defineProperties(proto.WebMessageInfo.prototype, {
		...
		isBaileys: {
			get() {
				return this.id?.startsWith('SH1Z0') && this.id?.length === 22 || false
			}
		},
		chat: {
			get() {
